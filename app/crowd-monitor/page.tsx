...
import { Users, Search, Thermometer, ShieldAlert, Sparkles } from 'lucide-react';
    ...
    return (
        <PageContainer>
            <SectionHeader
                ...
                actions={
                    <div className="flex items-center gap-1.5 rounded-full border border-blue-500/20 bg-blue-500/5 px-3 py-1 text-xs font-bold text-blue-400">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <StatCard
                    ...
                    icon={Users}
                    status="success"
                    description="Total active tickets scanned at entry turnstiles"
                />
                <StatCard
                    title="Avg Flow Rate"
                    value="420 fans/min"
                            ...
                            {sectors.map((sector) => (
                                <div key={sector.id} className="space-y-2">
                                    <div className="flex items-center justify-between text-xs font-semibold">
                                        ...
                                        <span className="text-zinc-400">{sector.occupancy} ({sector.pct}%)</span>
                                    </div>
                                    {/* Progress bar */}
                ...
                <div className="lg:col-span-5">
                    ...
                    >
                        <div className="space-y-4 mt-2">
                            <div className="rounded-xl border border-zinc-c800/80 bg-zinc-950/40 p-4 space-y-3">
                            ...
                            <div className="rounded-xl border border-zinc-800/85 bg-zinc-950/40 p-4 space-y-2">
                                <h4 className="text-xs font-bold text-white flex items-center gap-1.5">
